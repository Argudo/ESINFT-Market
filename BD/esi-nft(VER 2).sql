...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-05-2022 a las 11:53:42
...
INSERT INTO `usuarios` (`idMeta`, `nombre`, `email`, `saldo`) VALUES
...
--
ALTER TABLE `nfts`
  MODIFY `id_nft` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mercado`
  ADD CONSTRAINT `mercado_ibfk_1` FOREIGN KEY (`id_nft`) REFERENCES `nfts` (`id_nft`);
...
--
ALTER TABLE `transacciones`
  ADD CONSTRAINT `transacciones_ibfk_1` FOREIGN KEY (`id_vendedor`) REFERENCES `usuarios` (`idMeta`),
  ADD CONSTRAINT `transacciones_ibfk_2` FOREIGN KEY (`id_comprador`) REFERENCES `usuarios` (`idMeta`),
  ADD CONSTRAINT `transacciones_ibfk_3` FOREIGN KEY (`id_nft`) REFERENCES `nfts` (`id_nft`);
COMMIT;
